import { n as Wu } from './defaultSettingsView-Ds-bson8.js';
var vi = { exports: {} },
  _u = vi.exports,
  ha;
function It() {
      ...
      (function (Et, zt) {
        (function (C, De) {
          ...
          function sr(e) {
            ...
            return (
              D(e),
              !n || n.left == n.right ? !1 : (an = r.right - n.right < 3)
            );
          }
          var Pt =
              `
...
`
          ...
          function Fi(e) {
            return (
              e.display.scroller.clientHeight - Yt(e) - e.display.barHeight
            );
          }
          function vs(e, t, n) {
          ...
          function jt(e, t, n, r, i, o) {
            ...
            function l(M, E) {
              ...
              return (
                E ? (R.left = R.right) : (R.right = R.left),
                Yn(e, r, R, n)
              );
            }
                ...
                var nt = Vo(e, pe, null, tt),
                  ...
                  Qe =
                    ft == 'after'
                      ? nt.begin
                      : nt.end -
                        (/\s/.test(pe.text.charAt(nt.end - 1)) ? 2 : 1);
                return Xe(Qe, rt)[rt];
              }
            ...
            for (var i = 0; i < e.length; ++i) {
              ...
              if (o.ranges) {
                ...
                for (var a = 0; a < o.ranges.length; a++)
                  (Il(o.ranges[a].anchor, t, n, r),
                    Il(o.ranges[a].head, t, n, r));
                continue;
              }
...
`,
          ...
          oo.prototype.compare = function (e, t, n) {
            return (
              this.time + yu > e && Z(t, this.pos) == 0 && n == this.button
            );
          };
          var Pn, In;
          function xu(e, t) {
          ...
          function Du(e) {
            ...
            ((e.defineOption = n),
              ...
              n(
                ...
                [],
                function (r, i) {
                  ((r.display.gutterSpecs = Yi(i, r.options.lineNumbers)),
                    wn(r));
                },
                !0
              ),
            ...
            function k(x) {
              if (x.nodeType == 1) {
                ...
                if (!/^br$/i.test(x.nodeName) && x.textContent.length == 0)
                  return;
                Q && h();
                for (var G = 0; G < x.childNodes.length; G++)
                  k(x.childNodes[G]);
      ...
      (function (Et, zt) {
        (function (C) {
          ...
          C.defineMode('css', function (fe, H) {
            ...
            function Re(T) {
              return (
                T.context.prev && (T.context = T.context.prev),
                T.context.type
              );
            }
            function Ue(T, B, F) {
            ...
            function m(f, g) {
              if (g)
                if (g.block) {
                  ...
                  return S(f, g.vars)
                    ? g
                    : new P(g.prev, new le(f, g.vars), !1);
              else return null;
            }
            function y(f) {
              return (
            ...
            function Se(f, g) {
              ...
              if (f == 'variable' || D.style == 'keyword') {
                ...
                if (f == 'number' || f == 'string')
                  return (
                    (D.marked = V ? 'property' : D.style + ' property'),
                    d(Be)
                  );
        ...
        (function (C) {
          ...
          function Ee(m, y) {
            ...
            (le(y.keywords),
              ...
              P.length &&
                ((y.helperType = m[0]),
                C.registerHelper('hintWords', m[0], P)));
              ...
              for (var re = O[X.state], ne = 0; ne < re.length; ne++) {
                ...
                if (Ae) {
                  ...
                  if (
                    ...
                    return (
                      z.backUp(Ae[0].length - (Ae[1] ? Ae[1].length : 0)),
                      ye[0]
                    );
