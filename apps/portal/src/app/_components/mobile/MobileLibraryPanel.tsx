...
export function MobileLibraryPanel() {
  return (
    <section className="px-4 pb-28 pt-6" aria-labelledby="mobile-library-title">
      ...
      <h1
        id="mobile-library-title"
        className="mt-2 text-4xl font-black leading-tight text-black dark:text-white"
      >
        资料
      </h1>
