  ...
  return (
    <div className="hys-section">
      <div className="hys-container">
        ...
        {/* 主要操作区域 - 简洁的两栏布局 */}
        <div
          className="hys-grid grid-cols-1 md:grid-cols-2 max-w-5xl mx-auto mb-16 md:mb-24 gap-4 md:gap-6"
          role="region"
          aria-label="主要功能入口"
        >
          <Link
            ...
            >
              <CardContent className="p-0 relative z-10">
                <div className="mb-6 md:mb-8">
                  <h2 className="text-xl md:text-2xl font-normal mb-3 md:mb-4 tracking-wide text-white">
                    开始评估
                  </h2>
        ...
        {/* 快速访问链接 */}
        <div
          className="hys-grid grid-cols-1 md:grid-cols-3 max-w-5xl mx-auto mb-16 md:mb-24 gap-4 md:gap-6"
          data-tour-id="quick-access"
          role="region"
          aria-label="快速访问"
        >
        ...
        <div className="text-center">
          <div className="max-w-4xl mx-auto">
            <div
              className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-12 mb-12 md:mb-20"
              data-tour-id="system-features"
              role="list"
              aria-label="系统特色"
            >
              <div className="text-center" role="listitem">
                <div className="text-3xl md:text-4xl font-light mb-2 text-primary">
                  7
                </div>
