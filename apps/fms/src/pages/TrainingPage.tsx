    ...
    return (
      <div className="hys-section">
        <div className="hys-container">
          ...
          >
            <h1 className="hys-title text-2xl mb-4">暂无训练数据</h1>
      ...
      <div className="hys-container max-w-6xl">
        ...
        <div className="hys-grid grid-cols-2 lg:grid-cols-4 mb-12 md:mb-16 lg:mb-24 gap-2 md:gap-4" data-tour-id="training-overview">
          ...
          <FmsMetricCard
            ...
            detail={`${riskAssessment.description} · ${totalScore}/21分`}
          />
        </div>
        ...
        <div className="space-y-12 md:space-y-16 mb-12 md:mb-16 lg:mb-24" data-tour-id="training-phases">
          ...
          {comprehensiveTrainingPlan.phases.length === 0 ? (
            <Card className="hys-card bg-green-50 dark:bg-green-900/20 border-green-200">
              <CardContent className="p-8 md:p-12 text-center">
                <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center border-2 border-primary bg-primary/10">
                  <CheckCircle className="w-8 h-8 text-green-600" />
                </div>
                <h3 className="text-xl font-normal mb-4 text-green-900 dark:text-green-100">
                  动作功能优秀
                </h3>
                <p className="hys-text text-green-700 dark:text-green-300 max-w-md mx-auto">
            ...
            >
              {comprehensiveTrainingPlan.phases.map((phase) => (
                <AccordionItem
                  ...
                  className="hys-card border-none"
                  data-phase={`phase-${phase.phase}`}
                >
                  <AccordionTrigger className="border-b-2 border-border bg-muted/35 px-4 md:px-6 py-3 md:py-4 hover:no-underline hover:bg-muted/50">
                    <div className="flex items-center gap-2 md:gap-4 w-full min-w-0">
                      <div className="w-10 h-10 md:w-12 md:h-12 border-2 border-primary bg-primary text-primary-foreground flex items-center justify-center font-black text-sm md:text-base flex-shrink-0">
                        {phase.phase}
                      </div>
                        ...
                        <Card key={`${step.testId}-${step.step}`} className={`hys-card border-l-4 ${step.priority === 'critical' ? 'border-l-red-500' :
                          ...
                          <CardContent className="p-4 md:p-6">
                            {step.issue === 'pain' ? (
                              ...
                              <div className="space-y-4 md:space-y-6">
                                {/* 纠正策略 */}
                                <div className="hys-panel bg-muted/50 p-4 md:p-6">
                                  <h4 className="font-medium mb-3 flex items-center gap-2">
                                    <Target className="h-4 w-4" />
                                    纠正策略
                                  </h4>
                                  <p className="hys-text text-sm md:text-base">
                                    {step.strategy}
                                  </p>
                                </div>
        ...
        {/* 训练计划指导 */}
        <div data-tour-id="training-guidance">
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="training-guidance" className="hys-card">
              <AccordionTrigger className="px-4 md:px-6 py-3 md:py-4 hover:no-underline hover:bg-muted/30 rounded-t-lg">
              ...
              <AccordionContent className="px-4 md:px-6 pb-4 md:pb-6">
                <div className="space-y-6 md:space-y-8 pt-4">
                  ...
                  <div className="hys-grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    <div className="hys-panel bg-muted/30 p-4 md:p-6">
                      <h4 className="font-medium mb-3 flex items-center gap-2 text-sm md:text-base">
                        <RefreshCw className="h-4 w-4" />
                        训练频率建议
                      </h4>
                      <ul className="hys-text space-y-2 text-sm md:text-base">
                        <li>• 疼痛阶段：遵医嘱，配合康复</li>
                        <li>• 功能纠正：每周3-4次</li>
                        <li>• 质量优化：每周2-3次</li>
                        <li>• 4-6周重新评估一次</li>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 items-center mt-12 md:mt-16">
          ...
          <Button
            ...
            className="hys-button px-6 md:px-8"
          >
