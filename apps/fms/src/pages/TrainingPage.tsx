    ...
    <div className="hys-section">
      <div className="hys-container max-w-6xl">
        ...
        <div className="text-center mb-12 md:mb-16 lg:mb-20 minimal-fade-in">
          <h1 className="hys-title mb-6">个性化纠正训练方案</h1>
          <p className="hys-subtitle max-w-3xl mx-auto px-2 md:px-0">
        ...
        {/* 训练计划概览 - 移动端集约化显示 */}
        <div className="hys-grid grid-cols-2 lg:grid-cols-4 mb-12 md:mb-16 lg:mb-24 gap-2 md:gap-4">
          <CardWithIcon
            icon={Clock}
          ...
          >
            <CardContent className="p-4 md:p-6 relative z-10">
              ...
              <div className="hys-text text-sm">纠正项目</div>
            </CardContent>
          </CardWithIcon>
          ...
          >
            <CardContent className="p-4 md:p-6 relative z-10">
              ...
              <div className="hys-text text-sm">预计周数</div>
            </CardContent>
          </CardWithIcon>
          ...
          >
            <CardContent className="p-4 md:p-6 relative z-10">
              ...
              <div className="hys-text text-sm">总体评估</div>
              <div className="hys-text text-xs mt-1 text-muted-foreground">
