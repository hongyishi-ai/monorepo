      ...
      <header className="hys-nav">
        <div className="hys-container">
          <nav className="flex items-center justify-between py-3">
            ...
            <Link
              to="/"
              className="hys-logo hover:opacity-80 transition-opacity"
            ...
            <div className="hidden lg:flex items-center space-x-2">
              ...
              <TourHelpButton
                variant="outline"
                showText
                className="hys-guide-shell-button"
              />
              <ThemeToggle />
            </div>
            ...
            <div className="lg:hidden flex items-center space-x-1">
              ...
              >
                <span
                  ...
                  data-state={isMobileMenuOpen ? "close" : "menu"}
                >
                  <Menu
          ...
          {/* 移动端导航菜单 - 条件性显示 */}
          {isMobileMenuOpen && (
            <div className="t-stagger lg:hidden border-t border-border bg-background">
              <div className="py-4 space-y-2">
                <a
                  href="/"
                  className="t-stagger-line t-stagger-line--1 hys-nav-link block"
                >
                  总入口
                </a>
                {navigationItems.map((item) => (
                  <Link
                    key={item.to}
                    to={item.to}
                    className="t-stagger-line t-stagger-line--2 block"
                    onClick={closeMobileMenu}
                  >
                    <Button
                      variant="ghost"
        ...
        {mobileBottomItems.map((item) => {
          ...
          return (
            <Link
              ...
              to={item.to}
              className={cn(
                "hys-mobile-bottom-nav__item",
                active && "hys-mobile-bottom-nav__item--active",
              )}
            ...
            >
              <Icon
                aria-hidden="true"
                className="hys-mobile-bottom-nav__icon"
              />
